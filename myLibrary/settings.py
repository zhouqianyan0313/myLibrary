...
DATABASES = {
    'default': {#'django.db.backends.', 
        ...
        'USER': 'zqy_lb',                      # Not used with sqlite3.
        'PASSWORD': 'passlb',                  # Not used with sqlite3.
...
SECRET_KEY = '==2s0zw(t3eg=l_uzcavo@v8(*12l$nrtlzf1n2=pmn!3jl4$-'
...
TEMPLATE_DIRS = (
    ...
    #'E:\Django\sinaapp\zqylibrary\1\myLibrary\templates',
